...
export default function IntroSection() {
    return (
        <section id='intro-section' className='col-span-full w-full text-center row-start-1 pt-50 mb-50'>
