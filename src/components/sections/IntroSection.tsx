...
export default function IntroSection() {
    return (
        <section
            id='intro-section'
            className='grid place-items-center col-span-full w-full text-center row-start-1 pt-35 desktop:pt-50 mb-50'
        >
            ...
            <div className='w-[320px] desktop:hidden leading-[150%] text-lg mb-8 desktop:mb-24 whitespace-pre-line break-keep'>
                <p>
                    <span className='font-semibold'>뮤룸</span>은 기존 플랫폼 게시판 형태의 불편을 개선해 고객들이 훨씬
                    사용하기 쉬운 새로운 작업실 매물 탐색 플랫폼입니다.
                </p>
