    ...
    const opinionsAboutCommunityPlatform = [
        {
            title: `떨어지는\n커뮤니티의 인식`,
            description:
                '커뮤니티로 작업실을 구할 수 있는지도 몰랐습니다. 실용음악과 관련된 것들인 줄 알았어요. 네이버에 어디 근처 작업실이라는 키워드로 찾아도 잘 나왔습니다.',
            author: {
                age: '20대 남성',
                duration: '1년 이용',
                occupation: '성악과학생',
        ...
        },
        {
            title: '커뮤니티의\n불편한 사용성',
            description:
                '20대부터 커뮤니티를 사용하기 시작했습니다. 베이스 갤러리에서 중고 거래를 하다 알게 되어 커뮤니티의 존재를 알게 되고 이를 통해 작업실을 구하는 것도 알게 됐지만, 가독성이 불편하여 네이버 지도로 찾고 있습니다.',
            author: {
                age: '20대 남성',
                duration: '5년 이용',
                occupation: '베이시스트',
